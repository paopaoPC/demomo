define(
	...
	function(_, osUtil)
	{
		...
		Class.init = function()
		{
			...
			this._loadingHUD = $("<div id='netLoadingHUD' style='text-align: center; position:absolute;background-color:transparent;pointer-events:none;z-index:1;width:100%;height:100%'><div id='HUDView' style='background-color:rgba(0, 0, 0, 0.4)' class='bf-chrysanthemum active'><div></div><div style='font-size: 14px;color: white;margin-top: 50px;'>加载中...</div></div></div>");
