define(
    ...
    function (_, extend, osUtil)
    {
        ...
        Class.init = function()
        {
            ...
            this._debugHUD = $("<div id='debugHUD' style='position:absolute;background-color:transparent;pointer-events:none;z-index:2;width:100%;height:100%;text-align:center;'><div id='debugSwitch' style='pointer-events:auto;margin-left:auto;margin-right:auto;width:60px;height:38px;background-color:black;opacity:0.3;'></div><div id='debugFloating' style='position:absolute;width:100%;top:38px;bottom:0px;pointer-events:none;opacity:0.5;background-color:#888;'><textarea id='debugInfos' style=' width:100%;height:100%;font-size: 10px;line-height: 12px;padding:5px;margin: 0px;border: none;'></textarea></div></div>");
            root.append(this._debugHUD);
            this._debugHUD.find("#debugSwitch").on("click", function()
            {
                if(bfNaviController.getView('common/debug/debugView'))
                {
                    bfNaviController.pop();
                }
                else
                {
                    bfNaviController.push("common/debug/debugView.html", self._elemInfos);
                }
            });
            ...
            this.setDebugable(bfConfig.debugable);
        ...
        Class._appendMessage = function(tag, msg)
        {
            ...
            var self = this;
            osUtil.delayCall(function() // Use async call, these operations cost much time when profile
            {
