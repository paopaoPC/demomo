(function() {
	var m = Math,
		...
		trnClose = has3d ? ',0)' : ')',
		DR_iScroll = function(el, options) {
			var that = this,
				doc = document,
				i;
	...
	if (typeof exports !== 'undefined') exports.DR_iScroll = DR_iScroll;
	else window.DR_iScroll = DR_iScroll;
})();