	...
	function(View,Notification,CountDwon, codeInterface){
        ...
        var cls =
                {
                    events: {
                        ...
                        "click #forgetOldPin":"forgetOldPin"
                    }
                };
        ...
        cls.posGenHTML = function(){
            if(this._type == "setpin"){
                this.getElement("#pass_word").attr("placeHolder","请输入用户登录密码");
                this.getElement("#forgetOldPin").css("display","none");
        ...
        cls.forgetOldPin = function () {
            bfNaviController.push("cars/PinDrectionary/answerSecurity.html",{carId:this._carVin});
        };
        cls.onShow = function(){
            this.getImageCode();
        };
        ...
        cls._submitData = function(){
			...
			if(pin&&pin2&&currentVin&&cationCode){
				bfClient.setPINForCar({
                    ...
                    authCode:cationCode,
                    idCard: idCard
                }, function(data){self._onsubmitVinData(data)
            });
			}
        };
        cls._onsubmitVinData = function(data){
            ...
            if(data.code == 1) {
                ...
                if(me._type == "setpin"){
                    bfNaviController.pop(2,{isExist:"exist", from: "pin"});
                    return;
                }
