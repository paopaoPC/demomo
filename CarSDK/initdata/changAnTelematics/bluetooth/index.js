...
define(
    ...
    function (View, template, Butterfly,Swiper, Notification,moment) {
        var Base = View;
        var cls =
        {
            id: 'bluetoothView',
        ...
        cls.show_UIsuccess = function(){
            ...
            setTimeout(function(){
                ...
                if(gl){
                  ...
                  me.iframe_ht_1.show()
                  me.iframe_ht_1.attr('src','../ppResource/f201/index.html')
            ...
            setTimeout(function(){
                window.__getBlueToothStateByBlueeIndexView = function(data){
                 ...
                 if(deviceIsIOS){
                    ...
                    if(me.threeD){
                        me.threeD.contentWindow.openDoor('qlc', data.leftFrontDoorStatus?1:0);   //车门打开状态
                        me.threeD.contentWindow.openDoor('hlc', data.leftRearDoorStatus?1:0);
                        me.threeD.contentWindow.openDoor('qrc', data.rightFrontDoorStatus?1:0);
