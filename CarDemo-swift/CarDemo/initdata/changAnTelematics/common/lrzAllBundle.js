! function (e, t) {
    ...
    return function (e) {
        ...
        (function () {
            ...
            function l(e, t, n) {
                for (var r, i, o, a, s, c = new DataView(e), u = {}, l = t; t + n > l;) 28 === c.getUint8(l) && 2 === c.getUint8(l + 1) && (a = c.getUint8(l + 2), a in S && (o = c.getInt16(l + 3), s = o + 5, i = S[a], r = h(c, l + 5, o), u.hasOwnProperty(i) ? u[i] instanceof Array ? u[i].push(r) : u[i] = [u[i], r] : u[i] = r)), l++;
                return u
            }
            ...
            function f(e, t, n, r, i) {
                var o, a, s, c = e.getUint16(n, !i),
                    u = {};
                for (s = 0; c > s; s++) o = n + 12 * s + 2, a = r[e.getUint16(o, !i)], !a && p && console.log("Unknown tag: " + e.getUint16(o, !i)), u[a] = d(e, o, t, n, i);
                return u
            }
            ...
            function d(e, t, n, r, i) {
                ...
                switch (f) {
                    ...
                    case 7:
                        ...
                        for (o = d > 4 ? g : t + 8, a = [], c = 0; d > c; c++) a[c] = e.getUint8(o + c);
                        return a;
                    case 2:
                        return o = d > 4 ? g : t + 8, h(e, o, d - 1);
                    case 3:
                        if (1 == d) return e.getUint16(t + 8, !i);
                        for (o = d > 2 ? g : t + 8, a = [], c = 0; d > c; c++) a[c] = e.getUint16(o + 2 * c, !i);
                        return a;
                    case 4:
                        if (1 == d) return e.getUint32(t + 8, !i);
                        for (a = [], c = 0; d > c; c++) a[c] = e.getUint32(g + 4 * c, !i);
                        return a;
                    case 5:
                        if (1 == d) return u = e.getUint32(g, !i), l = e.getUint32(g + 4, !i), s = new Number(u / l), s.numerator = u, s.denominator = l, s;
                        for (a = [], c = 0; d > c; c++) u = e.getUint32(g + 8 * c, !i), l = e.getUint32(g + 4 + 8 * c, !i), a[c] = new Number(u / l), a[c].numerator = u, a[c].denominator = l;
                        return a;
                    case 9:
                        if (1 == d) return e.getInt32(t + 8, !i);
                        for (a = [], c = 0; d > c; c++) a[c] = e.getInt32(g + 4 * c, !i);
                        return a;
                    case 10:
                        if (1 == d) return e.getInt32(g, !i) / e.getInt32(g + 4, !i);
                        for (a = [], c = 0; d > c; c++) a[c] = e.getInt32(g + 8 * c, !i) / e.getInt32(g + 4 + 8 * c, !i);
                        return a
                }
            }
            ...
            function g(e, t) {
                ...
                if (8 > c) return p && console.log("Not valid TIFF data! (First offset less than 8)", e.getUint32(s + 4, !n)), !1;
        ...
        ! function () {
            ...
            function s(e, t, r, i) {
                ...
                g.width = g.height = h;
                for (var p = g.getContext("2d"), m = i ? o(e, a, s) : 1, w = Math.ceil(h * u / a), v = Math.ceil(h * l / s / m), y = 0, b = 0; s > y;) {
            ...
            u.prototype.render = function (e, t, n) {
                ...
                var i = this.srcImage,
                    ...
                    h = t.maxWidth,
                    g = t.maxHeight,
                    p = this.blob && "image/jpeg" === this.blob.type || 0 === o.indexOf("data:image/jpeg") || o.indexOf(".jpg") === c - 4 || o.indexOf(".jpeg") === c - 5;
                f && !d ? d = l * f / u << 0 : d && !f ? f = u * d / l << 0 : (f = u, d = l), h && f > h && (f = h, d = l * f / u << 0), g && d > g && (d = g, f = u * d / l << 0);
                var m = {
                    width: f,
                    height: d
                };
        ...
        function n(e) {
            function t(e) {
                ...
                for (var s = [1, 1.387039845, 1.306562965, 1.175875602, 1, .785694958, .5411961, .275899379], c = 0, u = 0; 8 > u; u++)
                    for (var l = 0; 8 > l; l++) U[c] = 1 / (x[N[c]] * s[u] * s[l] * 8), C[c] = 1 / (D[N[c]] * s[u] * s[l] * 8), c++
            }
            ...
            function p(e, t, n, r, i) {
                ...
                const l = 16,
                    f = 63,
                    d = 64;
                for (var h = u(e, t), g = 0; d > g; ++g) R[N[g]] = h[g];
                var p = R[0] - n;
            ...
            this.encode = function (e, t, n) {
                ...
                t && w(t), M = new Array, G = 0, O = 7, c(65496), l(), d(), f(e.width, e.height), h(), g();
                var i = 0,
                    o = 0,
                    s = 0;
                G = 0, O = 7, this.encode.displayName = "_encode_";
                for (var u, m, v, P, F, x, D, T, A, L = e.data, R = e.width, j = e.height, N = 4 * R, W = 0; j > W;) {
                    for (u = 0; N > u;) {
                        for (F = N * W + u, x = F, D = -1, T = 0, A = 0; 64 > A; A++) T = A >> 3, D = 4 * (7 & A), x = F + T * N + D, W + T >= j && (x -= N * (W + 1 + T - j)), u + D >= N && (x -= u + D - N + 4), m = L[x++], v = L[x++], P = L[x++], _[A] = (k[m] + k[v + 256 >> 0] + k[P + 512 >> 0] >> 16) - 128, B[A] = (k[m + 768 >> 0] + k[v + 1024 >> 0] + k[P + 1280 >> 0] >> 16) - 128, E[A] = (k[m + 1280 >> 0] + k[v + 1536 >> 0] + k[P + 1792 >> 0] >> 16) - 128;
        ...
        r.prototype.init = function () {
            var e = this,
                ...
                u = n ? t : URL.createObjectURL(t);
            if (e.img = i, e.blob = u, e.canvas = c, n ? e.fileName = r ? "base64.jpg" : t.split("/").pop() : e.fileName = t.name, !document.createElement("canvas").getContext) throw new Error("浏览器不支持canvas");
            ...
            return new a(function (i) {
                try {
                    c.getData("object" == typeof n ? n : t, function () {
