        ...
        function (defaultNavagationTemplate, View, elemUtil, disUtil)
        {
            ...
            cls.genHTML = function ()
            {
                ...
                if(elemContent)
                {
                    ...
                    if(platform=="iOS"){  //iOS添加title20px
                        ...
                        if(typeof OSApp !== 'undefined' && OSApp.isIphoneX && OSApp.isIphoneX()){
                            elemContent.css("top", (disUtil.navHeight+44)+"px");
                        } else {
            ...
            cls._setupNavigationBar = function()
            {
                ...
                if(!elemUtil.jsonAttr(elemNavBar, "navCustom"))
                {
                    ...
                    if(platform=="iOS"){  //iOS添加title20px
                        if(typeof OSApp !== 'undefined' && OSApp.isIphoneX && OSApp.isIphoneX()){
                            elemNavBar.css("height","88px");
                           navContainer.find(".im-default-nav-bar").css("padding-top", "44px"); 
                        } else {
