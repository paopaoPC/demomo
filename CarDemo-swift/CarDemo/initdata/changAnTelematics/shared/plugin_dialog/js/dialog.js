    ...
    function(){
        ...
        function dialog(opts){
            this.tpl = {
                ...
                '<div class="ui-btn ui-btn-<%=item.index%>" data-key="<%=item.key%>"><%=item.text%></div>'+
                '<% } %>'+
                '</div>'+
                '<% } %>' +
                '</div> '
...
//            console.log(this.tpl);
        ...
        this._init= function(){  
            ...
            $(document).ready(function() {
                ...
                if (btns.length == 1) {
                    $(".ui-dialog-content").addClass("active")
                };
                //bind events绑定事件
         ...
         this.refresh= function(){
            ...
            if(opts._isOpen) {
                ...
                action = function(){
                    ...
                    opts._wrap.css("-webkit-animation"," bounceOut 225ms");
                    opts._wrap.css("animation"," bounceOut 225ms");
                }
        ...
        this.close=function(){
            ...
            opts._isOpen = false;
            opts._wrap.css("-webkit-animation"," disappear 225ms");
            opts._wrap.css("animation"," disappear 225ms"); 
