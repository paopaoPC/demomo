    ...
    function(){
        ...
        function dialog(opts){
            this.tpl = {
                ...
                '</div>',
                wrap: 
                '<%if(isVersionUpdate){%><div class="ui-dialog-old-version-update"><%}else{%><div class="ui-dialog-old"><%}%>'+
                // '<div class="ui-dialog-old">'+
...
//            console.log(this.tpl);
        ...
        this._init= function(){  
            ...
            $(document).ready(function() {
                ...
                vars.isVersionUpdate = opts.isVersionUpdate;
            ...
            this._calculate= function(){
                ...
                if(opts.input){
                    ret.wrap = {
                        ...
                        marginTop: -round(size.height/2)-100 +'px'
                    }
                }else{
                    ret.wrap = {
                        left: '50%',
        ...
        opts.input&&(this._options.input=opts.input);
        opts.onShowCallBack && (this._options.onShowCallBack = opts.onShowCallBack);
        opts.isVersionUpdate && (this._options.isVersionUpdate = opts.isVersionUpdate);
    };
