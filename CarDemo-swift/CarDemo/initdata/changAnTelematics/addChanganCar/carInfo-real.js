    ...
    function (View, localResizeIMG, Butterfly, Notification, ImageCache, oldDialog) {
        ...
        return Base.extend({
            ...
            onShow: function () {
                ...
                if(!me.first){
                    me.first = true
                    if(this._carInfo_data.imagesPath[0]){
                        var img = "<img src='" + this._carInfo_data.imagesPath[0] + "' style='display:none' />";
                        this.$('.items.item1').append(img);
                        this.$('.items.item1').css('background-image','url('+this._carInfo_data.imagesPath[0]+')')
                    }
                    if(this._carInfo_data.imagesPath[1]){
                        var img = "<img src='" + this._carInfo_data.imagesPath[1] + "' style='display:none' />";
                        this.$('.items.item2').append(img);
                        this.$('.items.item2').css('background-image','url('+this._carInfo_data.imagesPath[1]+')')
                    }
                    if(this._carInfo_data.imagesPath[2]){
                    ...
                    if(this._carInfo_data.imagesPath[3]){
                    ...
                    var idcardType = this._carInfo_data.carInfo.idcardType;
                    var idCard = this._carInfo_data.carInfo.idcard;
                    this.$('#info_username').html(this._carInfo_data.carInfo.userFullname)
                    this.$('#info_vin').html(this._carInfo_data.carInfo.vin)



                    var select1 = this.getElement("#gender_select");
                    select1.find("option[value='" + this._carInfo_data.carInfo.gender + "']").attr({
                        "selected": true
                    })
            ...
            submitData: function (el) {
                ...
                var orderId = this._carInfo_data.carInfo.orderId ? this._carInfo_data.carInfo.orderId : "";
                var carInfo = {
                    orderId: this._carInfo_data.carInfo.orderId,
                    vin: this._carInfo_data.carInfo.vin,
                    enginNo: this._carInfo_data.carInfo.enginNo,
