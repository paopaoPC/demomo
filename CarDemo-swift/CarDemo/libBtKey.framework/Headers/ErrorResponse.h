...
typedef enum NSInteger{
    ...
    ErrorCode_CarOwnerInvalid = 505,//车主已失效或者已更换
    
    ErrorCode_BLEChanged = 506,//已经更换蓝牙设备，需要车主重新连接一次车辆已重新启用蓝牙功能
    
    ErrorCode_GrantInvalid = 507,//授权已失效
...
//    ErrorCode_UnbindBld = 2003,//未绑定蓝牙，请先绑定蓝牙
    ...
    ErrorCode_LimitedOperation = 2004,//离线操作受限，一般是网络不畅导致，需要联网操作一遍,只在蓝牙指令操作时反馈
    ...
    ErrorCode_BLETimeOut = 2010,//蓝牙指令超时
    
    ErrorCode_BLE_NOVIN = 2020,//蓝牙模块无VIN信息
    
    ErrorCode_BLE_VinCheckFaild = 2021,//蓝牙模块与车辆间VIN码校验失败，无法发送指令
